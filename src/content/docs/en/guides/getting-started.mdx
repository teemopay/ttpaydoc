...
description: Getting started with TTpay
---
...
TTpay is a global payment platform providing payment solutions for merchants worldwide.
...
3. Create Keys
   ...
   b. In the TTpay merchant background, exchange your public key with the platform public key;
